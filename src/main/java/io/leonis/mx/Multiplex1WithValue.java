...
public final class Multiplex1WithValue<I0, I1, N0> {
   ...
   */
  public <M0> Multiplex2WithValue<I0, I1, N0, M0> expand(final Function<I1, M0> multiplex) {
   ...
   * @throws Exception Thrown by the precomposition function when normalization fails.
   */
  public <K0, M0> Multiplex2WithValue<I1, I1, N0, M0> expand(
   ...
   * @throws Exception Thrown by the precomposition function when normalization fails.
   */
  public <K0, M0, M1> Multiplex3WithValue<I1, I1, N0, M0, M1> expand(
   ...
   * @throws Exception Thrown by the precomposition function when normalization fails.
   */
  public <K0, M0, M1, M2> Multiplex4WithValue<I1, I1, N0, M0, M1, M2> expand(
   ...
   * @throws Exception Thrown by the precomposition function when normalization fails.
   */
  public <K0, M0, M1, M2, M3> Multiplex5WithValue<I1, I1, N0, M0, M1, M2, M3> expand(
   ...
   * @throws Exception Thrown by the precomposition function when normalization fails.
   */
  public <K0, M0, M1, M2, M3, M4> Multiplex6WithValue<I1, I1, N0, M0, M1, M2, M3, M4> expand(
   ...
   * @throws Exception Thrown by the precomposition function when normalization fails.
   */
  public <K0, M0, M1, M2, M3, M4, M5> Multiplex7WithValue<I1, I1, N0, M0, M1, M2, M3, M4, M5> expand(
